...
class PdsHydrate(LambdaApplication):
    ...
    def start(self):
        ...
        try:
            ...
            self.response = json.dumps(self.pds_hydrate(nhs_number, job_id, patient_id))
    ...
    def pds_hydrate(self, nhs_number: str, job_id: str, patient_id: str) -> Success:
        ...
        lambda_ = boto3.client("lambda", region_name=self.system_config["AWS_REGION"])
        lambda_.invoke(
