...
def test_compare_patient_name_no_match_require_validation():
    ...
    expected = ACTION_REQUIRES_VALIDATION
...
def test_compare_patient_name_pds_lower_case_additional_update_pds():
    gp_forename = "Peter"
    gp_surname = "Smith"
    pds_givenNames = "Peter"
    pds_familyName = "smith"
